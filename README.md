...
### Introduction
This repository is a [ALX Software Engineering Project]. The school project consisted in writing a shell like sh (Bourne Shell) by Stephen Bourne  , in **C**, using a limited number of standard library functions, We wrote our own functins as well [Here](https://github.com/Ruchiogele/alx-low_level_programming)

The goal of this project to understand how a shell works. To single out some items: what is the *environment*, the difference between *functions* and *system calls*, how to create *processes* using `execve`...  
...
`` git clone https://github.com/Ruchiogele/simple_shell ``
...
##### List of built-ins
Currently the list of built-ins we've written:  
* cd [directory]  
